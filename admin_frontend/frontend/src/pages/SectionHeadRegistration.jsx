...
import { UserPlus, Save, AlertTriangle, CheckCircle, Briefcase } from 'lucide-react'; 
            ...
            {message && (
                <div 
                    className={`p-4 mb-6 rounded-lg flex items-center ${
                        message.type === 'success' ? 'bg-green-100 text-green-800 border-green-500' : 'bg-red-100 text-red-800 border-red-500'
                    } border-l-4`}
                    role="alert"
                >
