...
import { 
    Megaphone, PlusCircle, Trash2, Edit, Save, Calendar, User, 
    Upload, FileText, X, ChevronRight, FileX
} from 'lucide-react'; 

/**
 * @typedef {object} PdfAttachment
 * @property {string} name - The original file name.
 * @property {string} dataUrl - The Base64 Data URL for viewing the PDF.
 */
 ...
 * @property {PdfAttachment | null} pdfAttachment 
 */
...
const initialNotices /*: Notice[]*/ = [
    { 
        ...
        target: 'All Teams',
        author: 'Super Admin',
        pdfAttachment: null // We'll rely on the user adding a file for the demo
    },
    { 
        id: 2, 
...
export default function NoticesPage() {
    ...
    // Removed type annotation for editingNotice
    const [editingNotice, setEditingNotice] = useState(null); 
    const [selectedFile, setSelectedFile] = useState(null); 
    
    // Removed type annotation for formData
